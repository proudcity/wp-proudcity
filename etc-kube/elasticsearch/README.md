From: https://github.com/kubernetes/kubernetes/tree/master/examples/elasticsearch

```
export NAMESPACE=elasticsearch
kubectl create ns $NAMESPACE
kubectl --namespace=$NAMESPACE create -f service-account.yml
kubectl --namespace=$NAMESPACE create -f service.yml
kubectl --namespace=$NAMESPACE create -f rc.yml
```
