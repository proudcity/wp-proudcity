...
wp search-replace agency-template.proudcity.com "$HOST" --skip-columns=guid --allow-root
wp search-replace recovers.proudcity.com "$HOST" --skip-columns=guid --allow-root
wp search-replace coronavirus.proudcity.com "$HOST" --skip-columns=guid --allow-root
