...
wp delete option jetpack_options jetpack_activated jetpack_file_data jetpack_available_modules jetpack_security_report jetpack_log jetpack_private_options jetpack_unique_connection jetpack_protect_key --allow-root
